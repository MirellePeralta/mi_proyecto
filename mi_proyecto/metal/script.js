...
async function predict() {
    ...
    if (highestClassName.toLowerCase().includes("no metal")) {
        indicator.textContent = "Objeto no válido";
    } else if (highestClassName.toLowerCase().includes("metal")) {
        indicator.innerHTML = `<img src="images/metal.png" alt="metal" style="width: 500px; height: auto;">`;
    } else {
