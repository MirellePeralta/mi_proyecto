...
async function predict() {
    ...
    } else if (highestClassName.toLowerCase().includes("carton")) {
        indicator.innerHTML = `<img src="images/carton.png" alt="Carton" style="width: 500px; height: auto;">`;
    } else if (highestClassName.toLowerCase().includes("noreciclable")) {
        indicator.textContent = "Este tipo de cartón no es reciclable";
    } else {
